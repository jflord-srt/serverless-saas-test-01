...
export type LoadingOverlayContextProps = React.PropsWithChildren<{}>;
...
function Overlay() {
    ...
    return (
        <Backdrop id={`loading-Backdrop-${id}`} open={isLoading} sx={{ color: theme.palette.grey[500], zIndex: (theme) => theme.zIndex.drawer + 1 }}>
